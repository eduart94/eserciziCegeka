...
public class Program {
	...
	public static void main(String[] args) {
		ContrattoFisso primo = new ContrattoFisso("marco", "rossi", "mrcrsss", "3254443333", "wind", 10);
		ContrattoMobile secondo = new ContrattoMobile("luigi", "di maio", "dmilgisdka", "0292876256", "wind", 10);
